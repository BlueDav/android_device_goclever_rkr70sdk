...
PRODUCT_COPY_FILES += \
    ...
    $(VENDOR_PATH)/proprietary/system/etc/permissions/features.xml:system/etc/permissions/platform.xml \
#   $(VENDOR_PATH)/proprietary/system/etc/permissions/platform.xml:system/etc/permissions/features.xml
